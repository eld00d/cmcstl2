...
STL2_OPEN_NAMESPACE {
	...
	requires
		ForwardIterator<__f<I1>>() && Sentinel<__f<S1>, __f<I1>>() &&
		ForwardIterator<__f<I2>>() && IndirectlySwappable<__f<I1>, __f<I2>>()
	{
	...
	requires
		!is_array<remove_reference_t<I>>::value && ForwardIterator<__f<I>>() &&
